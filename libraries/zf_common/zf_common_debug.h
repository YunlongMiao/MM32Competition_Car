...
//#define DEBUG_UART_RX_PIN           ( UART1_RX_B7 )

//uart_init(UART_1, 115200, UART1_TX_B6, UART1_RX_B7);	//串口1使能

//uart_init(UART_2, 115200, UART2_TX_A2, UART2_RX_A3);	//串口2使能
...
void printf_bin_16(int num);						//二进制数打印——16位
void printf_bin_8(unsigned char num);		//二进制数打印——8位
