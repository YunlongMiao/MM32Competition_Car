...
float imu963ra_gyro_f_x = 0, imu963ra_gyro_f_y = 0, imu963ra_gyro_f_z = 0;
float imu963ra_acc_f_x = 0,  imu963ra_acc_f_y = 0,  imu963ra_acc_f_z = 0;
float imu963ra_mag_f_x = 0,  imu963ra_mag_f_y = 0,  imu963ra_mag_f_z = 0;
...
// 获取加速度X，Y，Z轴数据并转换为实际物理数据   单位为 g(m/s^2)
//-------------------------------------------------------------------------------------------------------------------
void imu963ra_get_acc (void)
{
	...
	imu963ra_acc_f_x = imu963ra_acc_transition(imu963ra_acc_x);
	
    imu963ra_acc_y = (int16)(((uint16)dat[3] << 8 | dat[2]));
	imu963ra_acc_f_y = imu963ra_acc_transition(imu963ra_acc_y);
	
    imu963ra_acc_z = (int16)(((uint16)dat[5] << 8 | dat[4]));
	imu963ra_acc_f_z = imu963ra_acc_transition(imu963ra_acc_z);
}
...
void imu963ra_get_gyro (void)
{
	...
	imu963ra_gyro_f_x = imu963ra_gyro_transition(imu963ra_gyro_x);
	
    imu963ra_gyro_y = (int16)(((uint16)dat[3] << 8 | dat[2]));
	imu963ra_gyro_f_y = imu963ra_gyro_transition(imu963ra_gyro_y);
	
    imu963ra_gyro_z = (int16)(((uint16)dat[5] << 8 | dat[4]));
	imu963ra_gyro_f_z = imu963ra_gyro_transition(imu963ra_gyro_z);
}
...
void imu963ra_get_mag (void)
{
    ...
    if(0x01 & temp_status)
    {
        ...
        imu963ra_mag_x = (int16)(((uint16)dat[1] << 8 | dat[0]));
			imu963ra_mag_f_x = imu963ra_mag_transition(imu963ra_mag_x);
			
        imu963ra_mag_y = (int16)(((uint16)dat[3] << 8 | dat[2]));
			imu963ra_mag_f_y = imu963ra_mag_transition(imu963ra_mag_y);
			
        imu963ra_mag_z = (int16)(((uint16)dat[5] << 8 | dat[4]));
			imu963ra_mag_f_z = imu963ra_mag_transition(imu963ra_mag_z);
